...
from PySide6.QtWidgets import QDialog, QApplication, QMainWindow, QPushButton, QMessageBox
from PyQt6 import QtCore, QtGui, QtWidgets
import sys
...
class Ui_MainWindow(object):
    ...
    def show_plot(self):
       ...
       # Dialog.setWindowTitle("Dialog")
        ...
        self.dialog.setGeometry(300, 500, 500, 500)
        self.dialog.resize(500, 500)
        self.dialog.move(1025, 190)
        self.dialog.setWindowTitle('Graphics')
